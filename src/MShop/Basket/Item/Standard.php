 ...
 * @subpackage Basket
 */
class Standard extends \Aimeos\MShop\Common\Item\Base implements \Aimeos\MShop\Basket\Item\Iface
{
    /**
    ...
    public function fromArray(array &$list, bool $private = false): \Aimeos\MShop\Common\Item\Iface
    {
        ...
        foreach ($list as $key => $value) {
            switch ($key) {
                case 'basket.customerid': $item->setCustomerId($value);
                    break;
                case 'basket.name': $item->setName($value);
                    break;
                default: continue 2;
            }
