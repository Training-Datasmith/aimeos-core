 ...
 * @subpackage Attribute
 */
class Standard extends \Aimeos\MShop\Common\Item\Base implements \Aimeos\MShop\Attribute\Item\Iface
{
    ...
    public function fromArray(array &$list, bool $private = false): \Aimeos\MShop\Common\Item\Iface
    {
        ...
        foreach ($list as $key => $value) {
            switch ($key) {
                case 'attribute.domain': $item->setDomain($value);
                    break;
                case 'attribute.code': $item->setCode($value);
                    break;
                case 'attribute.type': $item->setType($value);
                    break;
                case 'attribute.status': $item->setStatus((int) $value);
                    break;
                case 'attribute.position': $item->setPosition((int) $value);
                    break;
                case 'attribute.label': $item->setLabel($value);
                    break;
                default: continue 2;
            }
