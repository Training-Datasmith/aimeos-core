 ...
 * @subpackage Catalog
 */
class Standard extends \Aimeos\MShop\Common\Item\Base implements \Aimeos\MShop\Catalog\Item\Iface
{
    ...
    public function fromArray(array &$list, bool $private = false): \Aimeos\MShop\Common\Item\Iface
    {
        ...
        foreach ($list as $key => $value) {
            switch ($key) {
                case 'catalog.url': $item->setUrl($value);
                    break;
                case 'catalog.code': $item->setCode($value);
                    break;
                case 'catalog.label': $item->setLabel($value);
                    break;
                case 'catalog.target': $item->setTarget($value);
                    break;
                case 'catalog.status': $item->setStatus((int) $value);
                    break;
                case 'catalog.config': $item->setConfig((array) $value);
                    break;
                case 'catalog.pathid': !$private ?: $item->setPathId($value);
                    break;
                case 'catalog.id': !$private ?: $item->setId($value);
                    break;
                default: continue 2;
            }
