...
abstract class Base extends \Aimeos\M_Shop\Service\Provider\Base implements Iface
{
    ...
    {
        $url = $this->get_config_value('payment.url-success', '');
        return new \Aimeos\M_Shop\Common\Helper\Form\Standard($url, 'POST', []);
    }
    /**
    ...
    {
        return $order_service_item->add_attribute_items($this->attributes($attributes, 'payment'));
    }
    /**
