 ...
 * @subpackage Order
 */
class Standard extends \Aimeos\MShop\Order\Item\Address\Base implements \Aimeos\MShop\Order\Item\Address\Iface
{
    /**
    ...
    public function fromArray(array &$list, bool $private = false): \Aimeos\MShop\Common\Item\Iface
    {
        ...
        foreach ($list as $key => $value) {
            switch ($key) {
                case 'order.address.addressid': $item->setAddressId($value);
                    break;
                default: continue 2;
            }
