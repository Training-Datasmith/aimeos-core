 ...
 * @subpackage Order
 */
class Standard extends \Aimeos\MShop\Common\Item\Base implements \Aimeos\MShop\Order\Item\Service\Attribute\Iface
{
    ...
    public function fromArray(array &$list, bool $private = false): \Aimeos\MShop\Common\Item\Iface
    {
        ...
        foreach ($list as $key => $value) {
            switch ($key) {
                case 'order.service.attribute.attributeid': !$private ?: $item->setAttributeId($value);
                    break;
                case 'order.service.attribute.parentid': !$private ?: $item->setParentId($value);
                    break;
                case 'order.service.attribute.siteid': !$private ?: $item->setSiteId($value);
                    break;
                case 'order.service.attribute.type': $item->setType($value);
                    break;
                case 'order.service.attribute.name': $item->setName($value);
                    break;
                case 'order.service.attribute.code': $item->setCode($value);
                    break;
                case 'order.service.attribute.value': $item->setValue($value);
                    break;
                case 'order.service.attribute.price': $item->setPrice($value);
                    break;
                case 'order.service.attribute.quantity': $item->setQuantity($value);
                    break;
                default: continue 2;
            }
