...
trait DB
{
    ...
    protected function aggregateBase(
        \Aimeos\Base\Criteria\Iface $search,
        $keys,
        string $cfgPath,
        array $required = [],
        ?string $value = null,
     ...
     */
    protected function getCachedStatement(
        \Aimeos\Base\DB\Connection\Iface $conn,
        string $cfgkey,
        ?string $sql = null
    ): \Aimeos\Base\DB\Statement\Iface {
     ...
     */
    protected function searchItemsBase(
        \Aimeos\Base\DB\Connection\Iface $conn,
        \Aimeos\Base\Criteria\Iface $search,
        string $cfgPathSearch,
        string $cfgPathCount,
        array $required,
        ?int &$total = null,
        int $sitelevel = \Aimeos\MShop\Locale\Manager\Base::SITE_ALL,
        array $plugins = []
    ): \Aimeos\Base\DB\Result\Iface {
    ...
    protected function toExpression(
        ...
        $value,
        string $op = '==',
        int $type = \Aimeos\Base\DB\Statement\Base::PARAM_STR
    ): string {
        $types = ['marker' => $type];
