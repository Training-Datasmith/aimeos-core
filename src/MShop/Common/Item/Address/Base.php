 ...
 * @subpackage Common
 */
abstract class Base extends \Aimeos\MShop\Common\Item\Base implements \Aimeos\MShop\Common\Item\Address\Iface
{
    ...
    public function fromArray(array &$list, bool $private = false): \Aimeos\MShop\Common\Item\Iface
    {
        ...
        foreach ($list as $idx => $value) {
            ...
            switch ($key) {
                case 'parentid': !$private ?: $item->setParentId($value);
                    break;
                case 'type': $item->setType($value);
                    break;
                case 'salutation': $item->setSalutation($value);
                    break;
                case 'company': $item->setCompany($value);
                    break;
                case 'vatid': $item->setVatID($value);
                    break;
                case 'title': $item->setTitle($value);
                    break;
                case 'firstname': $item->setFirstname($value);
                    break;
                case 'lastname': $item->setLastname($value);
                    break;
                case 'address1': $item->setAddress1($value);
                    break;
                case 'address2': $item->setAddress2($value);
                    break;
                case 'address3': $item->setAddress3($value);
                    break;
                case 'postal': $item->setPostal($value);
                    break;
                case 'city': $item->setCity($value);
                    break;
                case 'state': $item->setState($value);
                    break;
                case 'countryid': $item->setCountryId($value);
                    break;
                case 'languageid': $item->setLanguageId($value);
                    break;
                case 'telephone': $item->setTelephone($value);
                    break;
                case 'telefax': $item->setTelefax($value);
                    break;
                case 'mobile': $item->setMobile($value);
                    break;
                case 'email': $item->setEmail($value);
                    break;
                case 'website': $item->setWebsite($value);
                    break;
                case 'longitude': $item->setLongitude($value);
                    break;
                case 'latitude': $item->setLatitude($value);
                    break;
                case 'birthday': $item->setBirthday($value);
                    break;
                case 'position': $item->setPosition($value);
                    break;
                default: continue 2;
            }
