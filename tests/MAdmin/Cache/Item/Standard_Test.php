...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals([ 'tag:1', 'tag:2' ], $this->object->getTags());
    }

    public function testSetTags()
    {
        $this->object->setTags([ 'tag:1', 'tag:3' ]);
        $this->assertEquals([ 'tag:1', 'tag:3' ], $this->object->getTags());
        $this->assertTrue($this->object->isModified());
    }
    ...
    public function testToArray()
    {
        ...
        $this->assertEquals([ 'tag:1', 'tag:2' ], $list['cache.tags']);
    }
}
