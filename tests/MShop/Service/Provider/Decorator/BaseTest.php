...
class BaseTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mock = $this->getMockBuilder(\Aimeos\MShop\Service\Provider\Payment\PrePay::class)
            ->setConstructorArgs([ $this->context, $item ])
            ->onlyMethods([ 'calcPrice', 'checkConfigBE', 'checkConfigFE', 'getConfigBE',
    ...
    public function testProcess()
    {
        ...
        $this->object->process($item, [ 'params' ]);
    }
...
class TestBase extends \Aimeos\MShop\Service\Provider\Decorator\Base implements \Aimeos\MShop\Service\Provider\Decorator\Iface
{
}
