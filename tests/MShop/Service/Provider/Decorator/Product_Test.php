...
class ProductTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->servItem->setConfig([ 'product.include' => '' ]);
    ...
    {
        $this->servItem->setConfig([ 'product.exclude' => '' ]);
    ...
    public function testIsAvailableExclude()
    {
        ...
        $this->servItem->setConfig([ 'product.exclude' => 'CNC' ]);
    ...
    {
        $this->basket->addProduct($this->getOrderProduct('CNC'));
        $this->servItem->setConfig([ 'product.exclude' => 'CNE,CNC' ]);
    ...
    {
        $this->basket->addProduct($this->getOrderProduct('CNC'));
        $this->servItem->setConfig([ 'product.include' => 'CNC' ]);
    ...
    {
        $this->basket->addProduct($this->getOrderProduct('CNC'));
        $this->servItem->setConfig([ 'product.include' => 'CNC,CNE' ]);
