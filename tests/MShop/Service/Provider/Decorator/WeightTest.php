...
class WeightTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->servItem->setConfig([ 'weight.min' => '12.75', 'weight.max' => '12.75' ]);
    ...
    {
        $this->servItem->setConfig([ 'weight.min' => '15' ]);
    ...
    {
        $this->servItem->setConfig([ 'weight.max' => '10' ]);
