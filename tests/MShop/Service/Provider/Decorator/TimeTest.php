...
class TimeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCheckConfigFE()
    {
        ...
        $config = [ 'time.hourminute' => '12:00' ];
        $expected = [ 'time.hourminute' => null ];
