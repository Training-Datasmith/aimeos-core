...
class PostalTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testIsAvailableNoIncludeBilling()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_PAYMENT);
        $this->servItem->setConfig([ 'postal.billing-include' => '' ]);
    ...
    public function testIsAvailableNoIncludeDelivery()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_DELIVERY);
        $this->servItem->setConfig([ 'postal.delivery-include' => '' ]);
    ...
    public function testIsAvailableNoExcludeBilling()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_PAYMENT);
        $this->servItem->setConfig([ 'postal.billing-exclude' => '' ]);
    ...
    public function testIsAvailableNoExcludeDelivery()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_DELIVERY);
        $this->servItem->setConfig([ 'postal.delivery-exclude' => '' ]);
    ...
    public function testIsAvailableExcludeBilling()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_PAYMENT);
        $this->servItem->setConfig([ 'postal.billing-exclude' => '025698' ]);
    ...
    public function testIsAvailableExcludeDelivery()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_DELIVERY);
        $this->servItem->setConfig([ 'postal.delivery-exclude' => '025698' ]);
    ...
    public function testIsAvailableIncludeBilling()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_PAYMENT);
        $this->servItem->setConfig([ 'postal.billing-include' => '025698' ]);
    ...
    public function testIsAvailableIncludeBillingPrefix()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_PAYMENT);
        $this->servItem->setConfig([ 'postal.billing-include' => '025' ]);
    ...
    public function testIsAvailableIncludeDelivery()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_DELIVERY);
        $this->servItem->setConfig([ 'postal.delivery-include' => '025698' ]);
    ...
    public function testIsAvailableIncludeBillingFailure()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_PAYMENT);
        $this->servItem->setConfig([ 'postal.billing-include' => '452168' ]);
    ...
    public function testIsAvailableIncludeDeliveryFailure()
    {
        ...
        $this->basket->addAddress($address, \Aimeos\MShop\Order\Item\Address\Base::TYPE_DELIVERY);
        $this->servItem->setConfig([ 'postal.delivery-include' => '452168' ]);
