...
class BasketValuesTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $config = [
            'basketvalues.total-value-min' => [ 'EUR' =>  320 ],
            'basketvalues.total-value-max' => [ 'EUR' => 1000 ],
        ];
    ...
    {
        $config = [
            'basketvalues.total-value-min' => [ 'EUR' =>  700 ],
            'basketvalues.total-value-max' => [ 'EUR' => 1000 ],
        ];
    ...
    {
        $config = [
            'basketvalues.total-value-min' => [ 'EUR' =>  50 ],
            'basketvalues.total-value-max' => [ 'EUR' => 320 ],
        ];
