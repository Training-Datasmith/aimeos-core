...
class QuantityTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCheckConfigBEOK()
    {
        ...
        $attributes = [ 'quantity.packagecosts' => '10.0' ];
    ...
    public function testCheckConfigBEFailure()
    {
        ...
        $attributes = [ 'quantity.packagecosts' => [] ];
        $result = $this->object->checkConfigBE($attributes);
    ...
    public function testCalcPrice()
    {
        ...
        $this->servItem->setConfig([ 'quantity.packagecosts' => '1' ]);
    ...
    public function testCalcPriceBundle()
    {
        ...
        $this->servItem->setConfig([ 'quantity.packagecosts' => '1.0' ]);
    ...
    public function testCalcPricePackageHalf()
    {
        ...
        $this->servItem->setConfig([ 'quantity.packagesize' => '5', 'quantity.packagecosts' => '2.50' ]);
    ...
    public function testCalcPricePackageFull()
    {
        ...
        $this->servItem->setConfig([ 'quantity.packagesize' => '7', 'quantity.packagecosts' => '5.00' ]);
