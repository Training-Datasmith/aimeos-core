...
class BaseTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $result = $this->object->checkConfigBE([ 'payment.url-success' => true ]);
...
class TestBase extends \Aimeos\MShop\Service\Provider\Payment\Base implements \Aimeos\MShop\Service\Provider\Payment\Iface
{
}
