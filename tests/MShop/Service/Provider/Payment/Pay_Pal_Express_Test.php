...
class PayPalExpressTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSetPaymentStatusNone()
    {
        ...
        $method->invokeArgs($this->object, [ $this->order, [] ]);
    ...
    public function testSetPaymentPending()
    {
        ...
        $method->invokeArgs($this->object, [ $this->order, [ 'PAYMENTSTATUS' => 'Pending', 'PENDINGREASON' => 'error' ] ]);
    ...
    public function testSetPaymentRefunded()
    {
        ...
        $method->invokeArgs($this->object, [ $this->order, [ 'PAYMENTSTATUS' => 'Refunded' ] ]);
    ...
    public function testSetPaymentCanceled()
    {
        ...
        $method->invokeArgs($this->object, [ $this->order, [ 'PAYMENTSTATUS' => 'Voided' ] ]);
    ...
    public function testSetPaymentInvalid()
    {
        ...
        $method->invokeArgs($this->object, [ $this->order, [ 'PAYMENTSTATUS' => 'Invalid' ] ]);
