...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        $this->values = [
            ...
            'service.config' => [ 'url' => 'https://localhost/' ],
            'service.status' => 1,
    ...
    {
        $this->assertEquals([ 'url' => 'https://localhost/' ], $this->object->getConfig());
    }
    ...
    {
        $return = $this->object->setConfig([ 'account' => 'testAccount' ]);

        $this->assertInstanceOf(\Aimeos\MShop\Service\Item\Iface::class, $return);
        $this->assertEquals([ 'account' => 'testAccount' ], $this->object->getConfig());
        $this->assertTrue($this->object->isModified());
    }
