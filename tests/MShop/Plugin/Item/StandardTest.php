...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals([ 'limit' => '40' ], $this->object->getConfig());
    }
    ...
    {
        $return = $this->object->setConfig([ 'threshold' => '20.00' ]);

        $this->assertInstanceOf(\Aimeos\MShop\Plugin\Item\Iface::class, $return);
        $this->assertEquals([ 'threshold' => '20.00' ], $this->object->getConfig());
        $this->assertEquals(true, $this->object->isModified());
    }
