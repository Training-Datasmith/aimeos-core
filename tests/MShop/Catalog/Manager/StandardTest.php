...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testSearchTranslation()
    {
        ...
        $item = $this->object->search($search, [ 'text' ])
    ...
    public function testGet()
    {
        ...
        $search->setConditions($search->and($conditions));
        $item = $this->object->search($search, [ 'text' ])->first();
    ...
    public function testGetTree()
    {
        ...
        $rootItem = $this->object->getTree($item->getId(), [ 'text' ], \Aimeos\MW\Tree\Manager\Base::LEVEL_TREE);
    ...
    public function testGetTreeWithConditions()
    {
        $search = $this->object->filter();
        $conditions = [
            $search->compare('==', 'catalog.code', [ 'root', 'categories' ]),
            $search->compare('==', 'catalog.editor', $this->editor),
        ];
        $search->setConditions($search->and($conditions));
