...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals([ 'testcategory' => '10' ], $this->object->getConfig());
    }
    ...
    {
        $return = $this->object->setConfig([ 'unitcategory' => '12' ]);

        $this->assertInstanceOf(\Aimeos\MShop\Catalog\Item\Iface::class, $return);
        $this->assertEquals([ 'unitcategory' => '12' ], $this->object->getConfig());
        $this->assertTrue($this->object->isModified());
    }
