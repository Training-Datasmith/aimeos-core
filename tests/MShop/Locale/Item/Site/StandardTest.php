...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        $this->values = [
            ...
            'locale.site.config' => [ 'timezone' => 'Europe/Berlin' ],
    ...
    {
        $this->assertEquals([ 'timezone' => 'Europe/Berlin' ], $this->object->getConfig());
    }
    ...
    {
        $return = $this->object->setConfig([ 'timezone' => 'Europe/Paris' ]);

        $this->assertInstanceOf(\Aimeos\MShop\Locale\Item\Site\Iface::class, $return);
        $this->assertEquals([ 'timezone' => 'Europe/Paris' ], $this->object->getConfig());
        $this->assertTrue($this->object->isModified());
    }
