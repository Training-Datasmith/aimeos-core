...
class SupplierTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->couponItem->setConfig([ 'supplier.code' => 'unitSupplier001' ]);
    ...
    {
        $this->couponItem->setConfig([ 'supplier.code' => 'unitSupplier002' ]);
    ...
    {
        $this->couponItem->setConfig([ 'supplier.code' => 'unitSupplier001,unitSupplier002' ]);
