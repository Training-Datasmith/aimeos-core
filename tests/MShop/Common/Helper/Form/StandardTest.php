...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->values = [
            'name' => new \Aimeos\Base\Criteria\Attribute\Standard([
                'code' => 'name',
                'internalcode' => 'name',
                'type' => 'string',
                'internaltype' => 'string',
            ...
            'site' => new \Aimeos\Base\Criteria\Attribute\Standard([
                'code' => 'site',
                'internalcode' => 'site',
                'type' => 'string',
                'internaltype' => 'string',
            ...
            'language' => new \Aimeos\Base\Criteria\Attribute\Standard([
                'code' => 'language',
            ...
            'domain' => new \Aimeos\Base\Criteria\Attribute\Standard([
                'code' => 'domain',
                'internalcode' => 'domain',
                'type' => 'string',
                'internaltype' => 'string',
    ...
    {
        $item = new \Aimeos\Base\Criteria\Attribute\Standard([
            'code' => 'name',
            'internalcode' => 'name',
            'type' => 'string',
            'internaltype' => 'string',
