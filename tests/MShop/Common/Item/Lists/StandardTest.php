...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals([ 'cnt' => '40' ], $this->object->getConfig());
    }
    ...
    {
        $return = $this->object->setConfig([ 'new value' => '20.00' ]);

        $this->assertInstanceOf(\Aimeos\MShop\Common\Item\Lists\Iface::class, $return);
        $this->assertEquals([ 'new value' => '20.00' ], $this->object->getConfig());
