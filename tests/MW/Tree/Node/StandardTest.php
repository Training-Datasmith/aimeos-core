...
class StandardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $child1 = new \Aimeos\MW\Tree\Node\Standard([ 'id' => null, 'label' => 'child1', 'status' => '0', 'custom' => 'test' ]);
        $child2 = new \Aimeos\MW\Tree\Node\Standard([ 'id' => null, 'label' => 'child2', 'status' => '1', 'custom' => 'test' ]);

        $this->object = new \Aimeos\MW\Tree\Node\Standard([ 'id' => 1, 'label' => 'parent', 'status' => '1', 'custom' => 'test' ], [ $child1, $child2 ]);
    }
    ...
    {
        $this->object->addChild(new \Aimeos\MW\Tree\Node\Standard([ 'id' => null, 'label' => 'child3' ]));
